      ...
      <div className="flex flex-row justify-between mt-4">
        ...
        <div className="flex flex-row">
          <IconButton
            ...
            onClick={() => scroll(scrollContainerRef3, -200)}
          />
          <IconButton
      ...
      >
        {RecommendedCard.map((Card) => (
          <div className=" bg-white w-auto h-auto rounded-lg mt-8 mr-10">
            ...
            <div className="flex flex-row justify-between mt-6 px-4"></div>
      ...
      <div className="flex flex-row justify-between mt-4">
        ...
        <div className="flex flex-row">
          <IconButton
            ...
            altText="Scroll left"
            classtype={"w-6 h-6 mr-1"}
            onClick={() => scroll(scrollContainerRef4, -200)}
          />
          <IconButton
            icon={IMAGE_PATHS.RIGHT_SCROLL}
            altText="Scroll right"
        ...
        {RecommendedCard.map((Card) => (
          <div className=" bg-white w-auto h-auto rounded-lg mt-8 mr-10">
            <img
              src={IMAGE_PATHS.VR}
              alt="VR"
              className="w-fit h-40 flex-shrink-0 mr-12"
            />
            <div className="mx-4 w-52">
              <p className="text-black text-xs not-italic font-medium capitalize">
                11 jun 2023
              </p>
              <p className="text-black text-sm not-italic font-medium capitalize">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit
                reprehenderit.
              </p>
              <p className="text-black text-xs not-italic font-light leading-3 capitalize mb-4">
                Duis aute irure dolor in reprehenderit in voluptate velit esse
                cillum dolore eu fugiat nulla pariatur.reprehenderit in
                voluptate
              </p>
              <button className="flex h-5 justify-center items-center bg-black rounded-2xl text-white text-xs not-italic font-light leading-7 capitalize p-3 mb-4">
                read more
                <img
                  src={IMAGE_PATHS.ARROW_FORWARD}
                  alt="Right"
